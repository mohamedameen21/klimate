    ...
    <>
      ...
      >
        <Button
          variant={"ghost"}
          size={"icon"}
          className="absolute right-1 top-1 h-5 w-6 rounded-full p-0 hover:text-destructive-foreground group-hover:opacity-100 cursor-pointer"
          onClick={(e) => {
            e.stopPropagation();
            onRemove(id);
